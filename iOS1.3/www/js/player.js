...
{	myPlaylist = new jPlayerPlaylist({
			jPlayer: "#jquery_jplayer_N",
					cssSelectorAncestor: "#jp_container_N"	}, [		{			title:"Cro Magnon Man",			artist:"The Stark Palace",			mp3:"http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3"					}	], {		playlistOptions: {			enableRemoveControls: true		},		swfPath: "js",		supplied: "mp3"	});
							});
function addToPlaylist(id)		{						var cancion;
